...
public final class LexerParserRobot202120 {
  ...
  public static void main(String[] args) {
    ...
    $try:try {
      ...
      $line=54;
      LexerParserRobot202120.testLexerParser($cast(gold.structures.automaton.ITransducer.class,lexer),$cast(gold.structures.automaton.IPushdownAutomaton.class,parser));
    }
    catch (Throwable $throwable) {
