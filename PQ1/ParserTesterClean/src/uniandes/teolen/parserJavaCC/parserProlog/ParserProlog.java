...
ArrayList<String> names = new ArrayList<String>();
  ...
  final public void pspecs() throws ParseException {
    pspec();
    label_1:
    while (true) {
  ...
  final public void pspec() throws ParseException {
    var();
    jj_consume_token(16);
 ...
 names.add(token.image);
  ...
  final public void tspecs() throws ParseException {
    tspec();
    label_2:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
  ...
  final public void places() throws ParseException {
    place();
    label_3:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
  ...
  if (!encontro) {{if (true) throw new Error("The place hasn't been assigned before: \u005c""+token.image+"\u005c"");}}
  }
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x8000,0x40000,0x4000,0x8000,};
   }
